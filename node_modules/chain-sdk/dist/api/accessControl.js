 ...
 */
var accessControl = function accessControl(client) {
  return {
    /**
    ...
    create: function create(params, cb) {
      return shared.create(client, '/create-acl-grant', params, { skipArray: true, cb: cb });
    },
    ...
    delete: function _delete(params, cb) {
      return shared.tryCallback(client.request('/revoke-acl-grant', params), cb);
    },
    ...
    list: function list(cb) {
      return shared.query(client, 'accessTokens', '/list-acl-grants', {}, { cb: cb });
    }
  };
};
